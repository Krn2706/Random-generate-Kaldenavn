...
const firstPart = [
  ...
  "Kramme", "Guld", "Prutte", "Misse", "Stjerne", "Tosse", "Grine", "Puller", "Sveske", "Mulle", "Tulle", "Smukke", "Sukker", "Lækker", "Sol", "Prinsesse", "Elske", "Charme", "Lækker", "Honning", "Nusse", "Skum-", "Mini", "Prinse", "Sommer", "Puslinge", "Kramme", "Nuller", "Bølle"
];

const secondPart = [
  "mus", "gøj", "tøs", "bamse", "-fis", "mis", "bøtte", "bean", "monster", "mås", 
  "bjørn", "klump", "top", "dyr", "kat", "lys", "tosse", "fyr", "dukke", "bisken", "trold", "sikke", "futmælk", "ling", "kage", "fidus", "-bar", "panda", "-muuh", "fugl", "boble", "blomst", "stjerne", "fisk", "gøjl", "stråle", "my", "-top"
];
